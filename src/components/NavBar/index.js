...
function NavBar() {
    ...
    return(
        <div>
            <div class='absolute inline-block top-6 left-28 sm:left-4 sm:top-6'>
                <Link to='/' style={{textDecoration: 'none', marginTop: '5px', padding: '0'}}><span class="text-lg hover:text-blue-400 rounded-md sm:text-base font-medium sm:px-1 sm:py-1">SR</span></Link>
            </div>
            <div class="absolute inline-block right-24 top-6 sm:right-4 sm:top-6">
