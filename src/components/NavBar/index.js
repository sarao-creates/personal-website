...
function NavBar() {
    ...
    return(
        <div class="h-full absolute right-24 top-6">
            ...
            <Link to='/experience' style={{textDecoration: 'none', marginTop: '5px', padding: '0'}}><span class="text-lg hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Experience</span></Link>
